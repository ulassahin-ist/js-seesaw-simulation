...
/* prettier-ignore */
const themes = {
  Vibrant: ["#ff0000", "#ff8700", "#ffd300","#deff0a","#a1ff0a","#0aff99","#0aefff","#147df5","#580aff","#be0aff",],
  Sunrise: ["#f6992d","#ed6a5a","#a75a5a","#60495a","#ffc800","#4c7680","#38a3a5","#7dba60","#c2d11b",],
  Pastel: ["#ffc3c3","#fdddc4","#faf6c5","#c9fac5","#c7f3e0","#c5e8fa","#d2d9fa","#dec5fa","#fac5f4",],
  Raindrops: ["#f72585","#b5179e","#7209b7","#560bad","#480ca8","#3a0ca3","#3f37c9","#4361ee","#4895ef","#4cc9f0",],
  Delight: ["#ff61ab","#ff6176","#ff8161","#ffb561","#ffea62","#dfff61","#abff61","#76ff61","#61ff81","#61ffb5",],
};
...
// Falling Ball Sequence Functions
...
function handleAuto() {
  ...
  const Interval = 1989; //I find it generates more random numbers this way
  const rect = elements.frame.getBoundingClientRect();
